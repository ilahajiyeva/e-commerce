...
<div class="bg-light py-3">
  ...
  <div class="site-section">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <img src="{{asset('assets/images/shoe_1.jpg')}}" alt="Image" class="img-fluid">
        </div>
        <div class="col-md-6">
          ...
          <p><a href="cart.html" class="buy-now btn btn-sm btn-primary">Səbətə əlavə et</a></p>
            ...
            <div class="item">
              <div class="block-4 text-center">
                <figure class="block-4-image">
                  <img src="{{ asset('assets/images/shoe.jpg') }}" alt="Image placeholder" class="img-fluid">
                </figure>
