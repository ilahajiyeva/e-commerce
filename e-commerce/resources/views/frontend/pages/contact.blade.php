...
<div class="bg-light py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12 mb-0">
            <a href="{{route('anasehife')}}">Ana Səhifə</a> <span class="mx-2 mb-0">/</span>
            <strong class="text-black">Əlaqə</strong></div>
      </div>
    </div>
  </div>
  ...
  <div class="site-section">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="h3 mb-3 text-black">Bizimlə Əlaqə</h2>
        </div>
        <div class="col-md-7">
            ...
            @endif
          <form action="{{route('elaqe.save')}}" method="post">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <label for="c_subject" class="text-black">Mövzu </label>
        ...
        <div class="col-md-5 ml-auto">
          <div class="p-4 border mb-3">
            <span class="d-block text-primary h6 text-uppercase">Ünvan</span>
